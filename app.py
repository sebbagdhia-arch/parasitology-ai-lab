...
with st.sidebar:
    ...
    # 🔹 أزرار التنقل الملونة
    st.markdown("### 📌 Navigation")
    nav_buttons = {
        "🏠 Home / Accueil / الرئيسية": "home",
        "🔬 Smart Scan / Scan Intelligent / الفحص الذكي": "scan",
        "📊 Dashboard / Tableau / لوحة التحكم": "dashboard",
        "ℹ️ About Project / À Propos / حول المشروع": "about"
    }
    ...
    # 🔹 Dark Mode Toggle
    dark = st.toggle("🌙 Dark Mode / Mode Nuit / الوضع الليلي", value=st.session_state.dark_mode)
    ...
    st.markdown("### ℹ️ About Project / À Propos / حول المشروع")
    if st.button("Open Info / Voir Info / عرض المعلومات", key="about_info"):
        st.info("هنا يمكنك وضع معلومات المشروع لاحقًا أو رابط لموقع المشروع أو وصفه...")
    
    # 🔹 Logout Button
    st.markdown("---")
    if st.button("🔴 Logout / Déconnexion / تسجيل الخروج", key="logout_btn"):
